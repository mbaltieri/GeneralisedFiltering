...
sigma_z_log = torch.tensor([2.])                                               # log-precision
...
B_u_gm = torch.tensor([[beta, 0, 0], [0, beta, 0], [0, 0, beta]])                     # input matrix (dynamics)
F_gm = torch.tensor([[1, 0, 0], [0, 1, 0], [0, 0, 0]])                          # observation matrix

sigma_z_log_GM = torch.tensor([6.])                                            # log-precision
...
sigma_v_log_GM = torch.tensor([-5.])                                            # log-precision
sigma_v_GM = torch.exp(sigma_v_log_GM)
Sigma_v_GM = torch.tensor([[sigma_v_GM, 0., 0.], [0., sigma_v_GM, 0.], 
            [0., 0, sigma_v_GM]], device=DEVICE)

dyda = 100000*torch.tensor([[2., 0., 0.], [0., 1., 0.], [0., 0., 0.]])
eta_u = torch.tensor([[50.], [0.], [0.]])                                                 # desired state
